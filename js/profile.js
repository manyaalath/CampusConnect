...
// ──────────────────────────────────────────
const profileExtras = {
  1:  { school: 'School of Engineering',    roll: 'CS2024001', email: 'sarah.chen@campus.edu',     badges: ['Research Lead', "Dean's List"],    interests: ['Machine Learning', 'Academic Research', 'Open Source', 'Mentoring'] },
  2:  { school: 'School of Engineering',    roll: 'ME2024035', email: 'marcus.t@campus.edu',       badges: ['Robotics Club', 'Active Member'],  interests: ['Robotics', 'Photography', 'Inter-college Basketball', '3D Printing'] },
  ...
  4:  { school: 'School of Sciences',       roll: 'PH2020004', email: 'james.wilson@campus.edu',   badges: ['Faculty Advisor', "Dean's List"], interests: ['Quantum Computing', 'Academic Research', 'Astrophysics', 'Open Source'] },
  5:  { school: 'School of Business',       roll: 'BA2023042', email: 'elena.r@campus.edu',        badges: ['Alumna', 'Active Contributor'],    interests: ['Marketing Strategy', 'Entrepreneurship', 'Open Source', 'Photography'] },
  6:  { school: 'School of Computing',      roll: 'DS2026007', email: 'kevin.p@campus.edu',        badges: ['AI Ethics Club', 'Active Member'], interests: ['Machine Learning', 'Open Source', 'Inter-college Basketball', 'Photography'] },
  7:  { school: 'School of Social Sciences', roll: 'PS2024029', email: 'sophie.m@campus.edu',      badges: ['Peer Counselor', 'Active Contributor'], interests: ['Mental Health Advocacy', 'Photography', 'Yoga', 'Open Source'] },
  8:  { school: 'School of Engineering',    roll: 'EE2018003', email: 'david.a@campus.edu',        badges: ['Lead Researcher', "Dean's List"], interests: ['IoT Systems', 'Academic Research', 'Football', 'Open Source'] },
  ...
  10: { school: 'School of Engineering',    roll: 'ME2010002', email: 'alan.brooks@campus.edu',    badges: ['Dept. Head', "Dean's List"],        interests: ['Thermal Engineering', 'Academic Research', 'Mentoring', 'Open Source'] },
